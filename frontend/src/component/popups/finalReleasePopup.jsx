                ...
                >
                    ...
                    <div className="p-4 space-y-3 bg-gradient-to-b from-gray-800 to-gray-900">
                        ...
                        <div className="flex flex-row justify-evenly">
                            <Button onClick={onConfirm} className="bg-gradient-to-r from-slate-900 to-teal-400 hover:from-teal-400 hover:to-teal-400 text-white font-bold py-2 px-4 rounded-full transition-all duration-200 transform hover:scale-105 hover:rotate-1 hover:shadow-neon">
                                Yes
                            </Button>
                            <Button onClick={onClose} className="bg-gradient-to-r from-slate-900 to-teal-400 hover:from-teal-400 hover:to-teal-400 text-white font-bold py-2 px-4 rounded-full transition-all duration-200 transform hover:scale-105 hover:rotate-1 hover:shadow-neon">
                                No
                            </Button>
                        </div>
                    </div>
...
export default FinalReleasePopup;
