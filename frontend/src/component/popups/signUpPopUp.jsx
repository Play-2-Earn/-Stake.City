...
const signUpPopUp = ({ isOpen, onClose, AlreadyUserClick, onRegisterSuccess }) => {
    ...
    const handleSignUp = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                onClose();
                onRegisterSuccess();
                alert("Registered successfully!, Please Login using your credentials");
            } else {
                ...
                >
                    ...
                    <div className="p-4 space-y-3 bg-gradient-to-b from-gray-800 to-gray-900">
                        ...
                        <InputField
                            ...
                            type="password"
                        />
                        <Button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-bold py-2 px-4 rounded-full transition-all duration-200 transform hover:scale-105 hover:rotate-1 hover:shadow-neon" type="submit">
