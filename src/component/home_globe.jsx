...
const HomeMapboxMap = ({ position, searchPerformed, showControls }) => {
  ...
  useEffect(() => {
    if (mapContainer.current) {
      ...
      // Set the background layer to be transparent
      map.on('load', () => {
      ...
      map.on('mousedown', () => { 
        ...
        spinEnabled = true; // Stop spinning on user interaction
      });
      map.on('dragend', () => {
